...
function inferCategory(category: string, title: string): string {
  ...
  // Check pantalons & vestes FIRST to prevent false matches from broad hoodie/sneaker keywords
  ...
  // Hoodies: removed "zip " to avoid false positives on product codes like "Abunszip"
  const hoodieKw = ["hoodie","sweat","capuche","pullover","crew neck","crewneck","sweater","sweatjacket","tracktop","track top","trainingstop","zip top","halfzip","half-zip","half zip","zipper ","fleece","flc po ","troyer","full zip track"];
