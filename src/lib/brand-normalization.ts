...
const KEYWORD_BRANDS: [string[], string][] = [
  [["air jordan", "jumpman", "jordan ", "jdb ", "j brkln", "j flight", "jordan los", "jordan post", "jordan 1", "jordan 4", "jordan 5", "jordan 11", "jordan mvp", "jordan remix", "jordan sky", "jordan essentials", "jordan brooklyn", "j brooklyn", "mj brooklyn", "jdg brooklyn", "wj brooklyn", "jdb brooklyn", "spizike low", "flight fleece", "flight mvp"], "Jordan"],
  [["air max", "air force", "air zoom", "air huarache", "sportswear", "dri-fit", "dri fit", "tech fleece", "acg ", "wmns ", "nsw ", "sb force", "sb chron", "sb dunk", "blazer", "cortez", "pegasus", "vomero", "shox ", "total 90", "windrunner", "tech woven", "one dri-fit", "dunk low", "dunk high", "m nk ", "w nk ", "b nk ", "force 1 ", "p-6000", "waffle one", "react ", "flyknit", "air rift", "huarache", "indy bra", "swoosh", "renew", "downshifter", "revolution ", "wearallday", "crater impact", "presto ", "killshot", "tailwind", "structure ", "zoom fly", "vapormax", "invincible", "panda retro", "nk df ", "nk dry", "nk club", "tech pack", "everyday max", "everyday plus", "everyday cotton stretch", "m nsw", "w nsw", "nsw essential", "nsw club", "nike "], "Nike"],
