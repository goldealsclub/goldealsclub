...
const KEYWORD_BRANDS: [string[], string][] = [
  [["air jordan", "jumpman", "jordan ", "jdb ", "j brkln", "flight ", "los ", "brooklyn ", "spizike low", "jordan remix", "jordan los", "jordan post", "jordan 1", "jordan 4", "jordan 5", "jordan 11", "jordan mvp", "j flight"], "Jordan"],
