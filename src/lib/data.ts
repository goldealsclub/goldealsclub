...
function inferCategory(category: string, title: string): Category {
  ...
  const pantsKw = ["pantalon","jogger","pant ","pants","legging","short ","shorts","bermuda","cargo","jogging","jean ","jeans","denim","flared","flare ","slim fit","baggy","survêtement","ensemble","trainingsanzüge","straight tp","tracküants","trackpant","track pant","sweatpant","training pant","tracksuit","trainingsanzug","track suit","inseam","trainingshose","jggr ","bootcut"];
