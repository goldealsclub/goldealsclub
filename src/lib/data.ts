...
function inferGender(genderField: string, description: string, title: string): Gender {
  ...
  const femmeKw = ["pour femme"," femme "," femme,"," femmes ","pour fille"," fille ","women","woman","wmns","w's ","ladies","damen"," mujer "," donna ",
    ...
    "wide leg","wide-leg","high rise","high-rise","low rise","flare flap","parachute high","ribbed tank","rib tank",
