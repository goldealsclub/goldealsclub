...
- [x] Verrouiller le détourage avec un corpus de référence et des métriques qualité
- [x] Exécuter ces contrôles avant chaque rendu et bloquer toute publication en régression
- [x] Ajouter ces contrôles à la CI avec rapport visuel exploitable
